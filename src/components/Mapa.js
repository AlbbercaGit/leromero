...
const Visitanos = () => {
  ...
  return (
 <main >
<div className="h-[60vh] w-full flex justify-center items-center font-sans flex-col ">
<div className="w-4/5 h-[12vh] flex justify-center items-center flex-col p-5 ">
    ...
    <div className="w-[90%] h-[36vh] flex justify-center items-center  flex-col py-5">
